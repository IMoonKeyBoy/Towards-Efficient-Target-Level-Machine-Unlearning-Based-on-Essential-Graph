        ...
        if isinstance(m, nn.Conv2d) and name in model_layer_names[len(model_layer_names) - 6:len(model_layer_names) - 1]:
            ...
            for temp_target_class in range(args.total_class_number):
                ...
                if temp_target_class == args.target_class:
                    ...
                    #show_cams(None, imgs, activation_maps, False, "cams"+"/"+args.run_name + "_" + str(args.target_layer) +"_" + str(args.target_class) + "_withbalance.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_class', type=int, default=2, help='which image you would like to show')
    parser.add_argument('--proportion', type=float, default=0.08, help='Learning Rate')
